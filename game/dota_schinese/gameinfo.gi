"GameInfo"
{
	...
	FileSystem
	{
		SteamAppId				816 // 244670		// This will mount all the GCFs we need (240=CS:S, 220=HL2).
		ToolsAppId				306580		// Tools will load this (ie: source SDK caches) to get things like materials\debug, materials\editor, etc.
		BreakpadAppId			306580	// Only necessary if (BreakpadAppId != SteamAppId). Upload minidumps as this alternate appid
